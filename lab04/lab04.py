...
def distance(city_a, city_b):
    ...
    distance = sqrt(pow(distance_lat,2)+pow(distance_lon,2))
    return distance
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    OKcity = make_city("_",lat,lon)
    distance_A = distance(OKcity,city_a)
    distance_B = distance(OKcity,city_b)
